...
class GWTokenizer:
    def __init__(self, dictionary_file):
        ...
        if "<start_dialogue>" not in self.word2i:
            self.word2i["<start_dialogue>"] = len(self.word2i)
        ...
        self.stop_word = "?"
        self.start_dialogue_word = "<start_dialogue>"
        ...
        self.start_dialogue = self.word2i[self.start_dialogue_word]
    ...
    def encode(self, question, is_answer=False, add_start_token=False, add_stop_token=False):
